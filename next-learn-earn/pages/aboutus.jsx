...
const aboutus = ({ sectionsData, testimonialsData, clientsData, worksData }) => {

  const testimonialList = testimonialsData.map((testimonial) => 
      <>
        <SwiperSlide>
  ...
  const clientList = clientsData.map((client) => 
      <>
          <SwiperSlide>
            <Image src={`/${client.image_src}`} className="img-fluid" width="60" height="60" alt="" />
            {/* <Image src={client.image_src} alt="" width="30" height="30" /> */}
            </SwiperSlide>
      </>
  );
...
export async function getServerSideProps() {
  ...
  return {
    props: {
      sectionsData: data[0].sections,
      testimonialsData: data[1].testimonials,
      clientsData: data[2].clients,
      worksData: data[3].works,
    }
  }
